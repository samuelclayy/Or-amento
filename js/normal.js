(function () {
  ...
  function atualizarTabelaProdutos() {
    ...
    var formContainer = document.getElementById('normal-itens-form');
    ...
    var frete = parseFloat(document.getElementById('normal-frete').value.replace(',', '.')) || 0;
  ...
  function initItens() {
    var container = document.getElementById('normal-itens-form');
    if (!container) return;
    ...
    document.getElementById('normal-add-item').addEventListener('click', function () {
      var idx = container.querySelectorAll('[data-index]').length;
      container.appendChild(construirLinhaItem(idx));
    });
    document.getElementById('normal-remover-item').addEventListener('click', function () {
  ...
  function initRetiradaPagamento() {
    var selRetirada = document.getElementById('normal-retirada');
    var enderecoGroup = document.getElementById('normal-endereco-group');
    var enderecoInput = document.getElementById('normal-endereco');
    var formaPagamento = document.getElementById('normal-forma-pagamento');
    var faturadoDiasGroup = document.getElementById('normal-faturado-dias-group');
    var faturadoDiasInput = document.getElementById('normal-faturado-dias');
  ...
  function initObservacoes() {
    var input = document.getElementById('normal-observacoes');
    if (!input) return;
    function atualizar() {
  ...
  function initFreteWatcher() {
    var freteInput = document.getElementById('normal-frete');
  ...
  document.addEventListener('DOMContentLoaded', function () {
    atualizarDataAtual();
    bindTexto('normal-empresa', 'empresa');
    bindTexto('normal-cnpj', 'cnpj');
    initItens();
